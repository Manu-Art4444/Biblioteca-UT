...
<html>
  <head>
    ...
    <!-- ACCIONES MODALES -->
    <style>
      #mVer .select2-container--default.select2-container--disabled .select2-selection--single {
        background: white;
      }
      #mVer [readonly]{
        background: white;
    ...
    <div id="mVer" class="modal fade" role="dialog">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h3 class="modal-title">Ver datos del libro</h3>
          </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
    ...
    <select style="width:100%" id="v_clasificacion" disabled class="select2 form-control ">
      ...
      <?
        ...
        ?>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-4 col-lg-9">
                      <div class="form-group">
                          <label for="v_obervaciones">Observaciones:</label>
