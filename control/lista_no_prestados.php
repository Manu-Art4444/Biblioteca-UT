    ...
    <tbody>
      ...
      $consulta=$conexion->query("SELECT
                                ...
                                FROM
                                  ...
                                  WHERE l.id_libro NOT IN (SELECT id_libro FROM biblioteca_prestamos WHERE vigente = 1)
      ...
      ?> 
        <tr id="tr-<?php echo $row[0]; ?>">
          ...
          <td class="centrar"> 
            <button onclick="seleccionarLibro(<?php echo $row["id_libro"]; ?>);" <?php echo $aBtn; ?> class="mB btn btn-success btn-sm" type="button">
